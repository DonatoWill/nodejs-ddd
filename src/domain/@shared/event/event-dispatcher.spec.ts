...
import FirstLogWhenCustomerCreatedHandler from "../../customer/event/handler/first-log-when-customer-created.handler";
import SecondLogWhenCustomerCreatedHandler from "../../customer/event/handler/second-log-when-customer-created.handler";
import SendWhenChangeCustomerAddressHandler from "../../customer/event/handler/send-when-change-customer-address.handler";
